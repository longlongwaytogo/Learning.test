...
osg::Node* createNeedle(float w, float h, float depth,const osg::Vec4& color, float angle,double period)
{
	...
	path->insert(0.0, osg::AnimationPath::ControlPoint(osg::Vec3(0.0f,depth,0.0f),
		osg::Quat(angle,osg::Y_AXIS)) );
	path->insert(period*0.5f,osg::AnimationPath::ControlPoint(osg::Vec3(0.0f,depth,0.0f),
		osg::Quat(angle + osg::PI,osg::Y_AXIS)) );
	path->insert(period, osg::AnimationPath::ControlPoint(osg::Vec3(0.0f, depth,0.0f),
	osg::Quat(angle+osg::PI*2,osg::Y_AXIS)) );
...
int main()
{
	...
	osg::ref_ptr<osg::Node> hour =   createNeedle(6.0f, 1.0f, -0.02f, osg::Vec4(1.0f,0.0f,0.0f,1.0f), osg::PI * hour_time /6.0f, 3600*24);
	osg::ref_ptr<osg::Node> minute = createNeedle(8.0f, 0.6f, -0.04f, osg::Vec4(0.0f,1.0f,0.0f,1.0f), osg::PI * min_time  /6.0f, 3600);
	osg::ref_ptr<osg::Node> second = createNeedle(10.0f,0.2f, -0.06f, osg::Vec4(1.0f,1.0f,0.0f,1.0f), osg::PI * sec_time  /30.0f,60);
	
	osg::ref_ptr<osg::Group> root = new osg::Group;
	root->addChild(createFace(15));
	root->addChild(hour);
