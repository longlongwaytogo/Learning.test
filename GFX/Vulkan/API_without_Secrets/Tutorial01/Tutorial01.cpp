...
#elif defined(VK_USE_PLATFORM_XCB_KHR) || defined(VK_USE_PLATFORMXLIB_KHR)
...
#include "ListofFunctions.inl"
	...
	bool Tutorial01::CreateInstance()
	{
		VkApplicationInfo application_info = {
			...
			nullptr,											// const void
			"AIP with out Secrets: Introduction to Vulkan", 	// const char *pApplicationName
		...
		VkInstanceCreateInfo instance_create_info = {
			...
			nullptr,											// const char* const *ppEnablelayerNames
...
#include "ListOfFunctions.inl"
	...
	bool Tutorial01::CheckPhysicalDeviceProperties(VkPhysicalDevice physical_device, uint32_t &queue_family_index)
	{
		...
		if (queue_families_count == 0) {
			std::cout << "Physical Device " << physical_device << " desn't have any queue families!" << std::endl;
			return false;
		}
		...
		std::cout << "Could not find queue family with required propertities on physical device " << physical_device << "!" << std::endl;
		return false;
	}
